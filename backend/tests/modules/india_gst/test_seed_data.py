...
from app.seeds.demo_data import get_clinic_data, set_language
...
def test_clinic_settings_exclude_country_for_non_tamil():
    """When LANG is not ta, the clinic settings must NOT include
    country=IN — the India GST hook should not activate."""
