...
|------------|-------|-----------|
| `inventory.read` | List/view items, valuation, movements | `GET /api/v1/inventory/`, `GET /api/v1/inventory/{item_id}`, `GET /api/v1/inventory/valuation`, `GET /api/v1/inventory/{item_id}/movements` |
